...
function enviarRegistroPartida(nick, tag, dificuldade, modo, pontos, duracao, data, hora) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const resposta = yield fetch("http://localhost:3000/registrar-partida", {
                method: "POST",
                headers: {
